...
class TestDataGenerator:
    ...
    def __init__(self):
        ...
        self.names = [
            "علي محمد حسن", "محمد أحمد علي", "رضا حسين صالح", "زينب عباس محمد",
            "فاطمة علي رضا", "حسن محمد علي", "مريم أحمد حسن", "أحمد علي محمد",
            "نور محمد أحمد", "سارة حسن علي", "يوسف محمد رضا", "ليلى أحمد حسين",
            "كريم علي أحمد", "هدى محمد حسن", "عمر أحمد علي", "آية حسن محمد",
            "حسام محمد أحمد", "نسرين علي حسن", "طارق أحمد محمد", "شيماء محمد علي",
            "باسم حسن أحمد", "نورا علي محمد", "سعد محمد حسن", "رنا أحمد علي",
            "ماجد علي حسن", "سلمى محمد أحمد", "وسام أحمد محمد", "دينا حسن علي",
            "خالد محمد أحمد", "منى علي حسن", "عادل أحمد محمد", "رغد محمد علي",
            "صلاح حسن أحمد", "هبة علي محمد", "جعفر محمد حسن", "رباب أحمد علي",
            "حيدر علي أحمد", "نجلاء محمد حسن", "قاسم أحمد محمد", "إيمان حسن علي",
            "مصطفى محمد أحمد", "سميرة علي حسن", "عبدالله أحمد محمد", "لبنى محمد علي",
            "فراس حسن أحمد", "غادة علي محمد", "نبيل محمد حسن", "سهى أحمد علي",
            "كاظم علي أحمد", "فرح محمد حسن", "منير أحمد محمد", "زهراء حسن علي",
            "عدنان محمد أحمد", "وداد علي حسن", "شاكر أحمد محمد", "أسماء محمد علي",
            "رائد حسن أحمد", "نادية علي محمد", "فؤاد محمد حسن", "عبير أحمد علي"
        ]
        ...
        # الشعب
        self.sections = ["أ", "ب", "ج", "د", "هـ", "و", "ز", "ح"]
        ...
        try:
            for school in schools_info:
                ...
                for i in range(school["students_count"]):
                    ...
                    guardian_name = random.choice(self.names)
