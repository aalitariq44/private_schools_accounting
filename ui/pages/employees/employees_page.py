...
class EmployeesPage(QWidget):
    ...
    def __init__(self):
        ...
        self.current_font_size = ui_settings_manager.get_font_size("employees")
        
        # قراءة إعدادات رؤية الإحصائيات
        self.statistics_visible = ui_settings_manager.get_statistics_visible("employees")
    ...
    def create_employees_table(self, layout):
        ...
        try:
            ...
            self.employees_table.setStyleSheet("QTableWidget::item { padding: 2px 4px; }")
    ...
    def change_font_size(self):
        ...
        try:
            ...
            if selected_size != self.current_font_size:
                ...
                success = ui_settings_manager.set_font_size("employees", selected_size)
    ...
    def toggle_statistics_visibility(self):
        ...
        try:
            ...
            # حفظ الإعداد الجديد
            success = ui_settings_manager.set_statistics_visible("employees", self.statistics_visible)
